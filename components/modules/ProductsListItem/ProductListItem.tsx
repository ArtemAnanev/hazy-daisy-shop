...
import ProductLabel from "@/components/modules/ProductsListItem/ProductLabel"
    ...
    <>
      ...
      item.type === 't-shirts' ? (
       ...
       <li className={styles.list__item}>
         {title ? (
           <span className={`${styles.list__item__label} ${isTitleForNew
           ...
           <ProductLabel isNew={item.isNew} isBestseller={item.isBestseller} />
           )}
