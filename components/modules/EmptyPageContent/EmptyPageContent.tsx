...
import ContentTitle from "@/components/modules/EmptyPageContent/ContentTitle"
import ContentLinks from "@/components/modules/EmptyPageContent/ContentLinks"
import styles from "@/styles/empty-content/index.module.scss"

const EmptyPageContent = ({subtitle, description, btnText, bgClassName, title, oopsWord, bgWordClassName, emptyWord}:
