...
import { addOverflowHiddenToBody, formatPrice, capitalizeFirstLetter } from "@/lib/utils/common"
import ProductAvailable from "@/components/elements/ProductAvailable/ProductAvailable"
import ProductColor from "@/components/modules/ProductsListItem/ProductColor"
          ...
          <div className={styles.product__top__bottom}>
            ...
            <div className={styles.product__top__inner}>
              {!!selectedSize ? (
                ...
                <div className={`counter ${styles.product__top__counter}`}>
                  <span>
